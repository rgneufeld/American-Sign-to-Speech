...
class Application:
    def __init__(self):
        ...
        for self.voice in self.engine.getProperty('voices'):
            print(self.voice)

        # self.voices = self.engine.getProperty("voices")  # Get all the available voices
        for self.voice in self.engine.getProperty('voices'):
            if language in self.voice.languages and gender == self.voice.gender:
        ...
        # Import all the required Neural Networks
